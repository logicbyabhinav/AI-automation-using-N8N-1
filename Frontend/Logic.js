...
function sendToN8N(timestamp) {
  const finaldata = JSON.parse(
    localStorage.getItem("ai_automation_form") || "{}",
  );

  const sorting = {
    personal: finaldata.step1 || {},
    project: finaldata.step2 || {},
    budget: finaldata.step3 || {},
    submittedat:timestamp || new Date().toISOString(),
  };

  fetch(
    "https://n8n-webservices-w2z8.onrender.com/webhook/03444bce-0593-431b-abfa-31e4d7b89247",
    {
      method: "POST",
